 ...
 * @author alfio
 */
public class ApplicationRingBufferDispatcherProviderMixin implements RingBufferDispatcherProvider {
     ...
     */
    public ApplicationRingBufferDispatcherProviderMixin(@Service final ReactorEnvironment env) {
        this.dispatcher = Environment.sharedDispatcher();
    }
